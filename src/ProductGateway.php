...
class ProductGateway
{
  ...
  public function create(array $data): string
  {
    ...
    $stmt->bindValue(":size", (isset($data['size'])) ? $data['size'] : 0, PDO::PARAM_INT);
    $stmt->bindValue(":is_available", (isset($data['is_available'])) ? (bool) $data['is_available'] : false, PDO::PARAM_BOOL);
